...
#     ws2.append('DID', 'Desciption', 'Length (Byte)','Value', '', 'BaseSW Name')
#     ws2.append('', '', '', '', '', 'Ticket BaseSW')
#     ws2.append('', '', '', '', '', 'Variant BaseSW')
#     ws2.append('', '', '', '', '', 'DID check variant BaseSW')
#     # wb5 = load_workbook('RFvalue2.xlsx')
#     ws5.title = "RFvalue_latestSW"
#     ws2.append('DID', 'Desciption', 'Length (Byte)','Value', '', 'LatestSW Name')
#     ws2.append('', '', '', '', '', 'Ticket LatestSW')
#     ws2.append('', '', '', '', '', 'Variant LatestSW')
#     ws2.append('', '', '', '', '', 'DID check variant LatestSW')
    ...
    while k < row_count:
        ...
        if str(row_list_values_baseSW) == 'None':
            ...
            if str(count_hexvalue_baseSW) < row_list_length_byte_baseSW:
                length_byte = (int(row_list_length_byte_baseSW) - count_hexvalue_baseSW) ** 2
    ...
    while k < row_count2:
        for row in range(o, j):
            for col in range(1, 2):
                ...
                row_list_DID_latestSW_lowercase = str(row_list_DID_latestSW).lower()
        ...
        if str(row_list_values_latestSW) == 'None':
            ...
            if str(count_hexvalue_latestSW) < row_list_length_byte_latestSW:
                length_byte = (int(row_list_length_byte_latestSW) - count_hexvalue_latestSW) ** 2
...
def variant_base_sw(id, number1, number2, number3, number4, tasks):
    ...
    for row in range(4, 5):
        for col in range(7, 8):
            ...
            row_DID_check_variant_BaseSW_lowercase = str(row_DID_check_variant_BaseSW).lower()
