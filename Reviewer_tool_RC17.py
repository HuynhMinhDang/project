    ...
    with open(url, 'r') as f:
        ...
        while len(result_of_string) > 0:
            ...
            try:
                ...
                missing_length_byte_of_EXPECTED = missing_length_byte_of_EXPECTED[:-1]
    ...
    with open(url, 'r') as f:
        ...
        while len(result_of_string) > 0:
            ...
            try:
                ...
                missing_length_byte_No_DPT_of_EXPECTED = value_of_EXPECTED.partition(".{")[2]
                missing_length_byte_No_DPT_of_EXPECTED = missing_length_byte_No_DPT_of_EXPECTED[:-1]

                length_of_EXPECTED = int(length_of_EXPECTED) + int(missing_length_byte_No_DPT_of_EXPECTED) - 4
