...
run_btn = tk.Button(frame2, textvariable=run_btn_text, command=start_program,font="bold", width=15).grid(row=0, column=0, pady=20)
run_btn_text.set("RUN")

frame2.pack()

noneFill = tk.StringVar()
noneLabel = tk.Label(frame3, textvariable=noneFill, font=('bold', 14), bg="#20bebe", fg="black").grid(row=0, column=0)
frame3.pack()
...
Programing_counter = tk.Spinbox(frame5, from_=0, to=10, width=10, font=('helvetica', 15)).grid(row=1, column=0, padx=30)
...
Programing_Attempt_counter = tk.Spinbox(frame5, from_=0, to=10, width=10, font=('helvetica', 15)).grid(row=1, column=1, padx=30)
