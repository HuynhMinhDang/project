...
id += 1
# base SW script
ws2.append(['ID_'+str(id),  '1.1 Base SW to Latest SW M3',
          '', '', '', '', '', 'Test group', '', ''])
id += 1
ws2.append(['ID_'+str(id),  '1.1.1 Flash Base SW via UART',
          '', '', '', '', '', 'Test group', '', ''])
id += 1
ws2.append(['ID_'+str(id),  '1.1.1.1 Flash SW', '',
          '', '', '', '', 'Test group', '', ''])
id += 1
ws2.append(['ID_'+str(id),  '1.1.1.1.1 UART flash'+baseSW, 'Detail information is mentioned in the ticket: '+tiket_baseSW,
