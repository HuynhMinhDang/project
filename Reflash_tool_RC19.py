...
def run_program():
    ...
    direct = Input_path_text.get()
    id = DID_baseSW(ws2, wb, id, number1, number2, number3, number4, direct)
    # id = DID_baseSW(ws2, wb, id, number1, number2, number3, number4, complete_str)
    # print(id)
...
def open_file():
    ...
    file_path = askopenfile(parent=app, mode='rb', title="Choose location take file", filetype=[
                            ("excel file", ".xlsx")])
    # file_path = filedialog.askdirectory(parent = app, filetype=[("excel file", ".xlsx")])
...
browse_btn_input_path = tk.Button(app, textvariable=browse_input_path_text,command=lambda: open_file(), font="Raleway", width=7, height=1)
browse_input_path_text.set("Browse")
...
browse_btn_output_path = tk.Button(app, textvariable=browse_output_path_text,command=lambda: save_file(), font="Raleway", width=7, height=1)
browse_output_path_text.set("Browse")
