            ...
            try:
                ...
                if value_of_EXPECTED_check_special == '.*':
                    ...
                    if value_of_EXPECTED_add_value != '':
                        ...
                        value_of_EXPECTED_check_special2_second = value_of_EXPECTED_second.partition(".{")[1]
                        value_of_EXPECTED_add_value_second = value_of_EXPECTED_second.partition(".*")[2]
                        value_of_EXPECTED_check_value_behinde_second = value_of_EXPECTED_second.split('.', 1)[0]
                    ...
                    if value_of_EXPECTED_check_special2 == '.{':
                        ...
                        # print(int(length_of_EXPECTED))
                        # print(int(missing_length_byte_of_EXPECTED))
