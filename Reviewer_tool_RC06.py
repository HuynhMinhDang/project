...
def review_report(ws_report_review, wb_report_review,url):
    ...
    sheet_report_review.column_dimensions['M'].number_format = numbers.FORMAT_TEXT
    ...
    sheet_report_review.column_dimensions['M'].alignment = alignment
    ...
    with open(url, 'r') as f:
        ...
        ws_report_review.append(['ID' , 'DID','Length Byte RECEIVED','ASCII RECEIVED Value', 'HEX RECEIVED Value','HEX EXPECTED Value', 'ASCII EXPECTED Value','Length Byte EXPECTED', 'DPT Value', 'Length Byte DPT','Result Length byte', 'Result Hex value', 'Result ASCII value'])
    ...
    while z < row_count_report_review_add_result + 1:
        for row in range(m, n):
            for col in range(3, 4):
                char = get_column_letter(col)
                length_of_RECEIVED_report = ws_report_review_add_result[char + str(row)].value
                # print(length_of_RECEIVED_report)
                
        for row in range(m, n):
            for col in range(4, 5):
                char = get_column_letter(col)
                ascii_string_of_RECEIVED_report = ws_report_review_add_result[char + str(row)].value
                # print(ascii_string_of_RECEIVED)

        for row in range(m, n):
            for col in range(5, 6):
                char = get_column_letter(col)
                value_of_RECEIVED_report = ws_report_review_add_result[char + str(row)].value
                # print(value_of_RECEIVED)
        
        for row in range(m, n):
            for col in range(6, 7):
                char = get_column_letter(col)
                value_of_EXPECTED_report = ws_report_review_add_result[char + str(row)].value
                # print(value_of_EXPECTED)
        
        for row in range(m, n):
            for col in range(7, 8):
                char = get_column_letter(col)
                ascii_string_of_EXPECTED_report = ws_report_review_add_result[char + str(row)].value
                # print(ascii_string_of_EXPECTED)

        for row in range(m, n):
            for col in range(8, 9):
                char = get_column_letter(col)
                length_of_EXPECTED_report = ws_report_review_add_result[char + str(row)].value
                # print(length_of_EXPECTED)
            
        for row in range(m, n):
            for col in range(10, 11):
                char = get_column_letter(col)
                length_of_DID_DPT_report = ws_report_review_add_result[char + str(row)].value
        ...
        # if str(value_of_EXPECTED_report) == str(value_of_RECEIVED_report) or str(ascii_string_of_EXPECTED_report) == str(ascii_string_of_RECEIVED_report) and str(length_of_EXPECTED_report) == str(length_of_RECEIVED_report) and str(length_of_EXPECTED_report) == str(length_of_DID_DPT_report):
        #     result = 'PASS'
        # else:
        #     result = 'FAIL'
        
        ws_report_review_add_result['K'+ str(z)] = str(result_length_value)
        ws_report_review_add_result['L'+ str(z)] = str(result_hex_value)
        ws_report_review_add_result['M'+ str(z)] = str(result_ascii_value)


        if str(result_length_value) == 'FAIL':
            for col in range(3, 4):
                cell_header_result_length_value = ws_report_review_add_result.cell(v, col)
            # used hex code for red color
            ...
            for col in range(11, 12):
                cell_header_result_length_value2 = ws_report_review_add_result.cell(v, col)
            # used hex code for red color
                cell_header_result_length_value2.fill = PatternFill(
                    start_color='00FF0000', end_color='00FF0000', fill_type="solid")
                cell_header_result_length_value2.border = border
                cell_header_result_length_value2.font = font_text3
                cell_header_result_length_value2.alignment = alignment
        ...
        if  str(result_hex_value) == 'FAIL':
            for col in range(5, 6):
                cell_header_result_hex_value = ws_report_review_add_result.cell(v, col)
            # used hex code for red color
            ...
            for col in range(12, 13):
                cell_header_result_hex_value2 = ws_report_review_add_result.cell(v, col)
            # used hex code for red color
                cell_header_result_hex_value2.fill = PatternFill(
                    start_color='00FF0000', end_color='00FF0000', fill_type="solid")
                cell_header_result_hex_value2.border = border
                cell_header_result_hex_value2.font = font_text3
                cell_header_result_hex_value2.alignment = alignment
        ...
        if  str(result_ascii_value) == 'FAIL':
            for col in range(4, 5):
                cell_header_result_ascii_value = ws_report_review_add_result.cell(v, col)
            # used hex code for red color
            ...
            for col in range(13, 14):
                cell_header_result_ascii_value2 = ws_report_review_add_result.cell(v, col)
            # used hex code for red color
                cell_header_result_ascii_value2.fill = PatternFill(
                    start_color='00FF0000', end_color='00FF0000', fill_type="solid")
                cell_header_result_ascii_value2.border = border
                cell_header_result_ascii_value2.font = font_text3
                cell_header_result_ascii_value2.alignment = alignment
