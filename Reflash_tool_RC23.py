...
def run_program():
    ...
    app.update_idletasks()
    number4 += 1
    ws2.append(['ID_'+str(id),  '1.' + str(number1) + '.' + str(number2) + '.' + str(number3) + '.' + str(number4) + ' 0201_ProgrammingAttemptCounter', 'To check value of the DID 0201', '1) Send service 0x22 to the camera for the DID 0201 using physical addressing','1) -', '1) RequestResponse(220201, 620201.*'+str(Programing_Attempt_counter_text.get())+', Regexp)', 'Automated Testcase', 'implemented', latestSW, ''])
...
browse_btn_input_path = tk.Button(frame1, textvariable=browse_input_path_text, command=lambda: open_file(), font="bold", width=7, height=1).grid(row=1, column=1, pady=5, padx=10)
browse_input_path_text.set("Browse")

# browse button save file
browse_output_path_text = tk.StringVar()
browse_btn_output_path = tk.Button(frame1, textvariable=browse_output_path_text, command=lambda: save_file(),font="bold", width=7, height=1).grid(row=3, column=1, pady=5, padx=10)
browse_output_path_text.set("Browse")
...
run_btn = tk.Button(frame1, textvariable=run_btn_text, command=start_program,font="bold", width=15).grid(row=4, column=0, columnspan = 2, pady=20)
...
noneLabel = tk.Label(frame1, textvariable=noneFill, font=('bold', 14), bg="#20bebe", fg="black").grid(row=5, column=0, columnspan = 2)
# frame3.pack()
...
percentLabel = tk.Label(frame1, textvariable=percent, font=('bold', 14), bg="#20bebe", fg="black").grid(row=7, column=0,columnspan = 2)
...
Programing_counter_label = tk.Label(frame2, text='Programing_counter_step', font=('bold', 14), bg="#20bebe", fg="black").grid(row=0, column=0, padx=30, pady=10, sticky='w')
Programing_counter = tk.Spinbox(frame2, textvariable=Programing_counter_text ,values  = step, width=10, font=('helvetica', 15)).grid(row=1, column=0, padx=30)



Programing_Attempt_counter_text = tk.StringVar()
Programing_Attempt_counter_label = tk.Label(frame2, text='Programing_Attempt_counter_step', font=('bold', 14), bg="#20bebe", fg="black").grid(row=0, column=1, padx=30, pady=10, sticky='w')
Programing_Attempt_counter = tk.Spinbox(frame2, textvariable=Programing_Attempt_counter_text ,values  = step, width=10, font=('helvetica', 15)).grid(row=1, column=1, padx=30)
