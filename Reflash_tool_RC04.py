...
# id += 1
# number4 += 1
DID_baseSW(ws2, wb, id, number1, number2, number3, number4)
...
# id += 1
# ws2.append(['ID_'+str(id),  '1.1.2 Re-Flash Latest SW M3 via X-Flash 1st',
#             '', '', '', '', '', 'Test group', '', ''])
# id += 1
# ws2.append(['ID_'+str(id),  '1.1.2.1.1 Xflash '+latestSW, 'Detail information is mentioned in the ticket: '+tiket_latestSW,
...
# id += 1
# ws2.append(['ID_'+str(id),  '1.1.2.2 Variant and Software  Identification',
#             '', '', '', '', '', 'Test group', '', ''])
# id += 1
# ws2.append(['ID_'+str(id),  '1.1.2.2.1 Select_and_check_variant', 'To Select and check variant', '1) Tester Present is ON\n2) Change to Extended session with Service 0x10 03\n3) Security unlock ON\n4) wait\n5) Security unlock OFF\n6) Select variant\n7) Check variant', '1) -\n2) -\n3) -\n4) -\n5) -\n6) -\n7) -',
