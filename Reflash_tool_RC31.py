...
# # tao ra sheet dummy sw

#         wb5.create_sheet("RFvalue_dummySW")
#         ws5 = wb5['RFvalue_dummySW']
...
#         sheet3.column_dimensions['H'].width = 40
...
#         sheet3.column_dimensions['H'].number_format = numbers.FORMAT_TEXT
...
#         sheet3.column_dimensions['H'].alignment = alignment
#         # column_count2 = sheet2.max_column
#         ws5.append(['DID', 'Description', 'Length (Byte)','ASCII Value', 'HEX_Value', 'Type'])
...
#         cell_header.alignment = alignment
#         # ws5.append(['', '', '', '', '', 'DID check variant LatestSW'])
#         ws5['G4'] = 'DID check variant DummySW'
#         cell_header = ws5.cell(4, 7)
#         cell_header.fill = PatternFill(start_color='000066CC', end_color='000066CC', fill_type="solid")
#         cell_header.border = border
#         cell_header.font = font_text
...
# # ket thuc sheet dummy sw
        ...
        cell_header.alignment = alignment
        # ws5.append(['', '', '', '', '', 'DID check variant LatestSW'])
        ws5['A4'] = 'Step counter of Programming Counter DID'
        ...
        ws5['A5'] = 'Step counter of Programming Attempt Counter DID'
