...
def DID_Compare_No_DPT(ws_report_review_DID_Compare_No_DPT, wb_report_review_DID_Compare_No_DPT,url):
    ...
    wb_report_review_DID_Compare_No_DPT = load_workbook('Report_review.xlsx')
    wb_add_dpt_value_to_report_review = load_workbook('Report_review.xlsx')
    wb_report_review_DID_Compare_No_DPT_add_result = load_workbook('Report_review.xlsx')
    wb_report_review_DID_Compare_No_DPT_Clear = load_workbook('Report_review.xlsx')



    

    ws_report_review_DID_Compare_No_DPT = wb_report_review_DID_Compare_No_DPT.active
    ws_report_review_DID_Compare_No_DPT_Clear = wb_report_review_DID_Compare_No_DPT.active
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.active
    ws_report_review_DID_Compare_No_DPT_add_result = wb_report_review_DID_Compare_No_DPT.active

    ws_report_review_DID_Compare_No_DPT = wb_report_review_DID_Compare_No_DPT['DID']
    ws_report_review_DID_Compare_No_DPT_Clear = wb_report_review_DID_Compare_No_DPT['DID']
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review['DID']
    ws_report_review_DID_Compare_No_DPT_add_result = wb_report_review_DID_Compare_No_DPT_add_result['DID']
    

    sheet_report_review_DID_Compare_No_DPT = wb_report_review_DID_Compare_No_DPT.worksheets[0]
    sheet_report_review_DID_Compare_No_DPT_Clear = wb_report_review_DID_Compare_No_DPT.worksheets[0]
    sheet_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.worksheets[0]
    sheet_report_review_DID_Compare_No_DPT_add_result = wb_report_review_DID_Compare_No_DPT_add_result.worksheets[0]


    row_count_report_review = sheet_report_review_DID_Compare_No_DPT.max_row
    row_count_report_review_Clear = sheet_report_review_DID_Compare_No_DPT_Clear.max_row    
    ...
    if row_count_report_review_Clear != '':
        ...
        while b < row_count_report_review_Clear:
            ws_report_review_DID_Compare_No_DPT.delete_rows(1)
            b += 1
            print("dang xoa")
        print("done")
        b = 0
    ...
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['D'].width = 20

    sheet_report_review_DID_Compare_No_DPT.column_dimensions['A'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['B'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['C'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['D'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['E'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['F'].number_format = numbers.FORMAT_TEXT

    sheet_report_review_DID_Compare_No_DPT.column_dimensions['A'].alignment = alignment
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['B'].alignment = alignment
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['C'].alignment = alignment
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['D'].alignment = alignment
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['E'].alignment = alignment
    sheet_report_review_DID_Compare_No_DPT.column_dimensions['F'].alignment = alignment
    ...
    with open(url, 'r') as f:
        ...
        for col in range(1, 5):
            cell_header = ws_report_review_DID_Compare_No_DPT.cell(1, col)
        ...
        while len(result_of_string) > 0:
            ...
            try:
                ...
                # print(value_of_EXPECTED)
                value_of_EXPECTED_check_special = value_of_EXPECTED.partition(".*")[1]
                value_of_EXPECTED_check_special2 = value_of_EXPECTED.partition(".{")[1]
                value_of_EXPECTED_add_value = value_of_EXPECTED.partition(".*")[2]
                value_of_EXPECTED_add_value2 = value_of_EXPECTED.partition("}")[2]
                value_of_EXPECTED_check_value_behinde = value_of_EXPECTED.split('.', 1)[0]
                value_of_EXPECTED_check_value_behinde_special2 = value_of_EXPECTED.split('}', 1)[0]
                ...
                if value_of_EXPECTED_check_special == '.*':
                    ...
                    if value_of_EXPECTED_add_value != '':
                        ...
                        length_of_EXPECTED = len(value_of_EXPECTED) + 4
                        fix_length = 'fix_first'
                        value_of_EXPECTED_second = value_of_EXPECTED
                        value_of_EXPECTED_check_special_second = value_of_EXPECTED_second.partition(".*")[1]
                        
                        value_of_EXPECTED_add_value_second = value_of_EXPECTED_second.partition(".*")[2]
                        
                        if value_of_EXPECTED_check_special_second == '.*':
                            value_of_EXPECTED = value_of_EXPECTED.split('.',1)[0]

                            if value_of_EXPECTED_add_value_second != '':
                                value_of_EXPECTED = str(value_of_EXPECTED) + ' ' + str(value_of_EXPECTED_add_value_second)

                                fix_length_byte_second = len(value_of_EXPECTED)
                                length_of_EXPECTED = len(value_of_EXPECTED) + 4
                                fix_length_second = 'fix_second'
                            else:
                                fix_length_byte_second = len(value_of_EXPECTED)
                                length_of_EXPECTED = len(value_of_EXPECTED) + 4
                                fix_length_second = 'fix_after_second'
                    ...
                    if value_of_EXPECTED_check_special2 == '.{':
                        ...
                        missing_length_byte_of_EXPECTED = missing_length_byte_of_EXPECTED.partition("}")[0]

                        value_of_EXPECTED = value_of_EXPECTED.split('.',1)[0]
                        # print(value_of_EXPECTED)
                        length_of_EXPECTED = int(length_of_EXPECTED) + int(missing_length_byte_of_EXPECTED) - 4

                        remove_length_fix = 'after'

                    #     if value_of_EXPECTED_add_value2 != '':
                    #         value_of_EXPECTED = value_of_EXPECTED.split('.', 1)[0]

                    #         value_of_EXPECTED  = str(value_of_EXPECTED) + str(value_of_EXPECTED_add_value2)

                    #         missing_length_byte_of_EXPECTED_second = value_of_EXPECTED.partition(".{")[2]
                    #         missing_length_byte_of_EXPECTED_second = missing_length_byte_of_EXPECTED_second.partition("}")[0]

                    #         length_of_EXPECTED = len(value_of_EXPECTED) + int(missing_length_byte_of_EXPECTED) + int(missing_length_byte_of_EXPECTED_second)

                    #         remove_length_fix = 'before'

                    #         value_of_EXPECTED_check_special2_second = value_of_EXPECTED.partition(".{")[1]
                    #         value_of_EXPECTED_add_value2_special2_second = value_of_EXPECTED.partition("}")[2]

                    #         if value_of_EXPECTED_check_special2_second == '.{':
                
                    #             value_of_EXPECTED = value_of_EXPECTED.split('.', 1)[0]

                    #             if value_of_EXPECTED_add_value2_special2_second != '':
                    #                 value_of_EXPECTED = str(value_of_EXPECTED) + ' ' + str(value_of_EXPECTED_add_value2_special2_second)
                    #                 length_of_EXPECTED = length_of_EXPECTED + len(value_of_EXPECTED)
                    #                 remove_length_fix = 'both'
                                
                    #     byte_object_of_EXPECTED = bytes.fromhex(value_of_EXPECTED)

                    #     assii_string_of_EXPECTED = bytes_object_of_EXPECTED.decode("ASCII")
            ...
            if fix_length_second == 'fix_after_second':
                fix_length = ''
                # print(fix_length_byte_second)
                # print(value_of_RECEIVED)
                fix_length_byte_second = fix_length_byte_second + 4
                value_of_RECEIVED = result_of_RECEIVED[4:fix_length_byte_second]
                length_of_RECEIVED = len(value_of_RECEIVED) + 4
                fix_length_second = ''
            ...
            # if remove_length_fix == 'after':
            #     remove_length = length_of_RECEIVED - int(missing_length_byte_of_EXPECTED)
            #     value_of_RECEIVED = result_of_RECEIVED[remove_length:]

            # if  remove_length_fix == 'before':
            #     missing_length_byte_of_EXPECTED_second = int(missing_length_byte_of_EXPECTED_second) + 4
            #     value_of_RECEIVED = result_of_RECEIVED[4:missing_length_byte_of_EXPECTED_second]
            #     length_of_RECEIVED = len(value_of_RECEIVED) + 4
            ...
            ws_report_review_DID_Compare_No_DPT.append(['ID_'+str(id) ,str(DID_of_RECEIVED),str(DID_of_EXPECTED),'' ])
    ...
    for row in range(2, id):
        data_validation = DataValidation(type='list', formula1 = data_validation_data)
        ws_report_review_DID_Compare_No_DPT.add_data_validation(data_validation)
        data_validation.add(ws_report_review_DID_Compare_No_DPT['D'+str(row)])
    
    direct_save = Output_path_text.get()

    wb_report_review_DID_Compare_No_DPT.save("Report_review.xlsx")

    # if direct_save == '':
    #         # print('Ok')
    #     wb_report_review_DID_Compare_No_DPT.save("Report_review.xlsx")
    # else:
    #     wb_report_review_DID_Compare_No_DPT.save(direct_save + '/'+'Report_review.xlsx')
    
    # wb_report_review_DID_Compare_No_DPT.close()


    wb_report_review_DID_Compare_No_DPT_add_result = load_workbook('Report_review.xlsx')
    ws_report_review_DID_Compare_No_DPT_add_result = wb_report_review_DID_Compare_No_DPT_add_result.active
    ws_report_review_DID_Compare_No_DPT_add_result = wb_report_review_DID_Compare_No_DPT_add_result['DID']

    sheet_report_review_add_result = wb_report_review_DID_Compare_No_DPT_add_result.worksheets[0]
    ...
    while z < row_count_report_review_add_result + 1:
        for row in range(m, n):
            for col in range(2, 3):
                ...
                DID_of_RECEIVED_report = ws_report_review_DID_Compare_No_DPT_add_result[char + str(row)].value
        ...
        for row in range(m, n):
            for col in range(3, 4):
                char = get_column_letter(col)
                DID_of_EXPECTED_report = ws_report_review_DID_Compare_No_DPT_add_result[char + str(row)].value
                # print(DID_of_EXPECTED)
            

        
        if str(DID_of_EXPECTED_report) == str(DID_of_RECEIVED_report):
            # print('pass DID ')
            result_DID_value = 'PASS'
        else:
            result_DID_value = 'FAIL'

        ws_report_review_DID_Compare_No_DPT_add_result['D'+ str(z)] = str(result_DID_value)

        if str(result_DID_value) == 'FAIL':
            for col in range(2, 5):
                cell_header_result_DID_value = ws_report_review_DID_Compare_No_DPT_add_result.cell(v, col)
            # used hex code for red color
    ...
    wb_report_review_DID_Compare_No_DPT_add_result.save("Report_review.xlsx")

    # if direct_save == '':
    #     wb_report_review_DID_Compare_No_DPT_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_DID_Compare_No_DPT_add_result.save(direct_save + '/'+'Report_review.xlsx')

    
    wb_report_review_DID_Compare_No_DPT_add_result.close()

    # messagebox.showinfo("COMPLETE", "File Report_review.xlsx has been created in the same folder tool successfully")
    # print('tao thanh cong')

def Length_Byte_No_DPT(ws_report_review_Length_Byte_No_DPT, wb_report_review_Length_Byte_No_DPT,url):

    wb_report_review_Length_Byte_No_DPT = load_workbook('Report_review.xlsx')
    wb_add_dpt_value_to_report_review = load_workbook('Report_review.xlsx')
    wb_report_review_Length_Byte_No_DPT_add_result = load_workbook('Report_review.xlsx')
    wb_report_review_Length_Byte_No_DPT_Clear = load_workbook('Report_review.xlsx')

    ws_report_review_Length_Byte_No_DPT = wb_report_review_Length_Byte_No_DPT.active
    ws_report_review_Length_Byte_No_DPT_Clear = wb_report_review_Length_Byte_No_DPT.active
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.active
    ws_report_review_Length_Byte_No_DPT_add_result = wb_report_review_Length_Byte_No_DPT.active

    ws_report_review_Length_Byte_No_DPT = wb_report_review_Length_Byte_No_DPT['Length Byte']
    ws_report_review_Length_Byte_No_DPT_Clear = wb_report_review_Length_Byte_No_DPT['Length Byte']
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review['Length Byte']
    ws_report_review_Length_Byte_No_DPT_add_result = wb_report_review_Length_Byte_No_DPT_add_result['Length Byte']

    sheet_report_review_Length_Byte_No_DPT = wb_report_review_Length_Byte_No_DPT.worksheets[1]
    sheet_report_review_Length_Byte_No_DPT_Clear = wb_report_review_Length_Byte_No_DPT.worksheets[1]
    sheet_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.worksheets[1]
    sheet_report_review_Length_Byte_No_DPT_add_result = wb_report_review_Length_Byte_No_DPT_add_result.worksheets[1]


    row_count_report_review = sheet_report_review_Length_Byte_No_DPT.max_row
    row_count_report_review_Clear = sheet_report_review_Length_Byte_No_DPT_Clear.max_row    
    row_count_add_dpt_value_to_report_review = sheet_add_dpt_value_to_report_review.max_row
    ...
    if row_count_report_review_Clear != '':
        b = 0
        while b < row_count_report_review_Clear:
            ws_report_review_Length_Byte_No_DPT.delete_rows(1)
            b += 1
            print("dang xoa")
        print("done")
        b = 0
    ...
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['E'].width = 20

    sheet_report_review_Length_Byte_No_DPT.column_dimensions['A'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['B'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['C'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['D'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['E'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['F'].number_format = numbers.FORMAT_TEXT

    sheet_report_review_Length_Byte_No_DPT.column_dimensions['A'].alignment = alignment
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['B'].alignment = alignment
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['C'].alignment = alignment
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['D'].alignment = alignment
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['E'].alignment = alignment
    sheet_report_review_Length_Byte_No_DPT.column_dimensions['F'].alignment = alignment
    ...
    with open(url, 'r') as f:
        ...
        ws_report_review_Length_Byte_No_DPT.append(['ID' , 'DID','RECEIVED','EXPECTED','RESULT'])
        
        for col in range(1, 6):
            cell_header = ws_report_review_Length_Byte_No_DPT.cell(1, col)
            # used hex code for red color
            cell_header.fill = PatternFill(
                start_color='000066CC', end_color='000066CC', fill_type="solid")
            cell_header.border = border
        ...
        while len(result_of_string) > 0:
            ...
            ws_report_review_Length_Byte_No_DPT.append(['ID_'+str(id) , str(DID_of_EXPECTED),str(length_of_RECEIVED),str(length_of_EXPECTED),'' , '', '','',''])
    ...
    for row in range(2, id):
        data_validation = DataValidation(type='list', formula1 = data_validation_data)
        ws_report_review_Length_Byte_No_DPT.add_data_validation(data_validation)
        data_validation.add(ws_report_review_Length_Byte_No_DPT['E'+str(row)])
    
    direct_save = Output_path_text.get()

    wb_report_review_Length_Byte_No_DPT.save("Report_review.xlsx")

    # if direct_save == '':
    #         # print('Ok')
    #     wb_report_review_Length_Byte_No_DPT.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Length_Byte_No_DPT.save(direct_save + '/'+'Report_review.xlsx')
    
    wb_report_review_Length_Byte_No_DPT.close()


    wb_report_review_Length_Byte_No_DPT_add_result = load_workbook('Report_review.xlsx')
    ws_report_review_Length_Byte_No_DPT_add_result = wb_report_review_Length_Byte_No_DPT_add_result.active
    ws_report_review_Length_Byte_No_DPT_add_result = wb_report_review_Length_Byte_No_DPT_add_result['Length Byte']

    sheet_report_review_add_result = wb_report_review_Length_Byte_No_DPT_add_result.worksheets[1]
    row_count_report_review_add_result = sheet_report_review_add_result.max_row
    ...
    while z < row_count_report_review_add_result + 1:
        for row in range(m, n):
            for col in range(3, 4):
                char = get_column_letter(col)
                length_of_RECEIVED_report = ws_report_review_Length_Byte_No_DPT_add_result[char + str(row)].value
        ...
        for row in range(m, n):
            for col in range(4, 5):
                char = get_column_letter(col)
                length_of_EXPECTED_report = ws_report_review_Length_Byte_No_DPT_add_result[char + str(row)].value
                # print(length_of_EXPECTED)
            
        
        if str(length_of_EXPECTED_report) == str(length_of_RECEIVED_report):
            # print('pass length ')
            result_length_value = 'PASS'
        else:
            result_length_value = 'FAIL'

        ws_report_review_Length_Byte_No_DPT_add_result['E'+ str(z)] = str(result_length_value)

        if str(result_length_value) == 'FAIL':
            for col in range(2, 6):
                cell_header_result_length_value = ws_report_review_Length_Byte_No_DPT_add_result.cell(v, col)
            # used hex code for red color
    ...
    wb_report_review_Length_Byte_No_DPT_add_result.save("Report_review.xlsx")


    # if direct_save == '':
    #     wb_report_review_Length_Byte_No_DPT_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Length_Byte_No_DPT_add_result.save(direct_save + '/'+'Report_review.xlsx')

    
    wb_report_review_Length_Byte_No_DPT_add_result.close()

    # messagebox.showinfo("COMPLETE", "File Report_review.xlsx has been created in the same folder tool successfully")
    # print('tao thanh cong')

def Hex_value_No_DPT(ws_report_review_Hex_value_No_DPT, wb_report_review_Hex_value_No_DPT,url):
    
    wb_report_review_Hex_value_No_DPT = load_workbook('Report_review.xlsx')
    wb_add_dpt_value_to_report_review = load_workbook('Report_review.xlsx')
    wb_report_review_Hex_value_No_DPT_add_result = load_workbook('Report_review.xlsx')
    wb_report_review_Hex_value_No_DPT_Clear = load_workbook('Report_review.xlsx')

    ws_report_review_Hex_value_No_DPT = wb_report_review_Hex_value_No_DPT.active
    ws_report_review_Hex_value_No_DPT_Clear = wb_report_review_Hex_value_No_DPT.active
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.active
    ws_report_review_Hex_value_No_DPT_add_result = wb_report_review_Hex_value_No_DPT.active

    ws_report_review_Hex_value_No_DPT = wb_report_review_Hex_value_No_DPT['Hex Value']
    ws_report_review_Hex_value_No_DPT_Clear = wb_report_review_Hex_value_No_DPT['Hex Value']
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review['Hex Value']
    ws_report_review_Hex_value_No_DPT_add_result = wb_report_review_Hex_value_No_DPT_add_result['Hex Value']

    sheet_report_review_Hex_value_No_DPT = wb_report_review_Hex_value_No_DPT.worksheets[2]
    sheet_report_review_Hex_value_No_DPT_Clear = wb_report_review_Hex_value_No_DPT.worksheets[2]
    sheet_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.worksheets[2]
    sheet_report_review_Hex_value_No_DPT_add_result = wb_report_review_Hex_value_No_DPT_add_result.worksheets[2]


    row_count_report_review = sheet_report_review_Hex_value_No_DPT.max_row
    row_count_report_review_Clear = sheet_report_review_Hex_value_No_DPT_Clear.max_row    
    row_count_add_dpt_value_to_report_review = sheet_add_dpt_value_to_report_review.max_row

    if row_count_report_review_Clear != '':
        b = 0
        while b < row_count_report_review_Clear:
            ws_report_review_Hex_value_No_DPT.delete_rows(1)
            b += 1
            print("dang xoa")
        print("done")
        b = 0
    ...
    sheet_report_review_Hex_value_No_DPT.column_dimensions['B'].width = 40
    sheet_report_review_Hex_value_No_DPT.column_dimensions['C'].width = 40
    sheet_report_review_Hex_value_No_DPT.column_dimensions['D'].width = 40
    sheet_report_review_Hex_value_No_DPT.column_dimensions['E'].width = 20

    sheet_report_review_Hex_value_No_DPT.column_dimensions['A'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Hex_value_No_DPT.column_dimensions['B'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Hex_value_No_DPT.column_dimensions['C'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Hex_value_No_DPT.column_dimensions['D'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Hex_value_No_DPT.column_dimensions['E'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Hex_value_No_DPT.column_dimensions['F'].number_format = numbers.FORMAT_TEXT

    sheet_report_review_Hex_value_No_DPT.column_dimensions['A'].alignment = alignment
    sheet_report_review_Hex_value_No_DPT.column_dimensions['B'].alignment = alignment
    sheet_report_review_Hex_value_No_DPT.column_dimensions['C'].alignment = alignment
    sheet_report_review_Hex_value_No_DPT.column_dimensions['D'].alignment = alignment
    sheet_report_review_Hex_value_No_DPT.column_dimensions['E'].alignment = alignment
    sheet_report_review_Hex_value_No_DPT.column_dimensions['F'].alignment = alignment
    ...
    with open(url, 'r') as f:
        ...
        ws_report_review_Hex_value_No_DPT.append(['ID' , 'DID','RECEIVED','EXPECTED', 'RESULT'])
        
        for col in range(1, 6):
            cell_header = ws_report_review_Hex_value_No_DPT.cell(1, col)
            # used hex code for red color
            cell_header.fill = PatternFill(
                start_color='000066CC', end_color='000066CC', fill_type="solid")
            cell_header.border = border
        ...
        while len(result_of_string) > 0:
            ...
            ws_report_review_Hex_value_No_DPT.append(['ID_'+str(id) , str(DID_of_EXPECTED),str(value_of_RECEIVED),str(value_of_EXPECTED),'' ])
    ...
    for row in range(2, id):
        data_validation = DataValidation(type='list', formula1 = data_validation_data)
        ws_report_review_Hex_value_No_DPT.add_data_validation(data_validation)
        data_validation.add(ws_report_review_Hex_value_No_DPT['E'+str(row)])
    
    
    wb_report_review_Hex_value_No_DPT.save("Report_review.xlsx")
    ...
    #     wb_report_review_Hex_value_No_DPT.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Hex_value_No_DPT.save(direct_save + '/'+'Report_review.xlsx')
    
    wb_report_review_Hex_value_No_DPT.close()

    wb_report_review_Hex_value_No_DPT_add_result = load_workbook('Report_review.xlsx')
    ws_report_review_Hex_value_No_DPT_add_result = wb_report_review_Hex_value_No_DPT_add_result.active
    ws_report_review_Hex_value_No_DPT_add_result = wb_report_review_Hex_value_No_DPT_add_result['Hex Value']

    sheet_report_review_add_result = wb_report_review_Hex_value_No_DPT_add_result.worksheets[2]
    row_count_report_review_add_result = sheet_report_review_add_result.max_row
    ...
    ws_report_review_Length_Byte_add_result = wb_report_review_Length_Byte_add_result.active
    ws_report_review_Length_Byte_add_result = wb_report_review_Length_Byte_add_result['Length Byte']
    ...
    while z < row_count_report_review_add_result + 1:
        ...
        for row in range(m, n):
            for col in range(3, 4):
                char = get_column_letter(col)
                value_of_RECEIVED_report = ws_report_review_Hex_value_No_DPT_add_result[char + str(row)].value
                # print(value_of_RECEIVED)
        
        for row in range(m, n):
            for col in range(4, 5):
                char = get_column_letter(col)
                value_of_EXPECTED_report = ws_report_review_Hex_value_No_DPT_add_result[char + str(row)].value
                # print(value_of_EXPECTED)

        
        if str(value_of_EXPECTED_report) == str(value_of_RECEIVED_report):
            # print('pass hex value')
            result_hex_value_No_DPT = 'PASS'
        else:
            result_hex_value_No_DPT = 'FAIL'
        ...
        ws_report_review_Hex_value_No_DPT_add_result['E'+ str(z)] = str(result_hex_value_No_DPT)

        if  str(result_hex_value_No_DPT) == 'FAIL':
            for col in range(2, 6):
                cell_header_result_hex_value_No_DPT = ws_report_review_Hex_value_No_DPT_add_result.cell(v, col)
            # used hex code for red color
                cell_header_result_hex_value_No_DPT.fill = PatternFill(
                    start_color='00FF0000', end_color='00FF0000', fill_type="solid")
                cell_header_result_hex_value_No_DPT.border = border
                cell_header_result_hex_value_No_DPT.font = font_text3
                cell_header_result_hex_value_No_DPT.alignment = alignment
    ...
    wb_report_review_Hex_value_No_DPT_add_result.save("Report_review.xlsx")


    # if direct_save == '':
    #     wb_report_review_Hex_value_No_DPT_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Hex_value_No_DPT_add_result.save(direct_save + '/'+'Report_review.xlsx')

    
    wb_report_review_Hex_value_No_DPT_add_result.close()

    # messagebox.showinfo("COMPLETE", "File Report_review.xlsx has been created in the same folder tool successfully")
    # print('tao thanh cong')

def ASCII_Value_No_DPT(ws_report_review_ASCII_value_No_DPT, wb_report_review_ASCII_value_No_DPT,url):
    
    wb_report_review_ASCII_value_No_DPT = load_workbook('Report_review.xlsx')
    wb_add_dpt_value_to_report_review = load_workbook('Report_review.xlsx')
    wb_report_review_ASCII_value_No_DPT_add_result = load_workbook('Report_review.xlsx')
    wb_report_review_ASCII_value_No_DPT_Clear = load_workbook('Report_review.xlsx')

    ws_report_review_ASCII_value_No_DPT = wb_report_review_ASCII_value_No_DPT.active
    ws_report_review_ASCII_value_No_DPT_Clear = wb_report_review_ASCII_value_No_DPT.active
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.active
    ws_report_review_ASCII_value_No_DPT_add_result = wb_report_review_ASCII_value_No_DPT.active

    ws_report_review_ASCII_value_No_DPT = wb_report_review_ASCII_value_No_DPT['ASCII Value']
    ws_report_review_ASCII_value_No_DPT_Clear = wb_report_review_ASCII_value_No_DPT['ASCII Value']
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review['ASCII Value']
    ws_report_review_ASCII_value_No_DPT_add_result = wb_report_review_ASCII_value_No_DPT_add_result['ASCII Value']

    sheet_report_review_ASCII_value_No_DPT = wb_report_review_ASCII_value_No_DPT.worksheets[3]
    sheet_report_review_ASCII_value_No_DPT_Clear = wb_report_review_ASCII_value_No_DPT.worksheets[3]
    sheet_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.worksheets[3]
    sheet_report_review_ASCII_value_No_DPT_add_result = wb_report_review_ASCII_value_No_DPT_add_result.worksheets[3]


    row_count_report_review = sheet_report_review_ASCII_value_No_DPT.max_row
    row_count_report_review_Clear = sheet_report_review_ASCII_value_No_DPT_Clear.max_row    
    row_count_add_dpt_value_to_report_review = sheet_add_dpt_value_to_report_review.max_row

    if row_count_report_review_Clear != '':
        b = 0
        while b < row_count_report_review_Clear:
            ws_report_review_ASCII_value_No_DPT.delete_rows(1)
            b += 1
            print("dang xoa")
        print("done")
        b = 0
    ...
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['C'].width = 30
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['D'].width = 30
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['E'].width = 20
    

    sheet_report_review_ASCII_value_No_DPT.column_dimensions['A'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['B'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['C'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['D'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['E'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['F'].number_format = numbers.FORMAT_TEXT

    sheet_report_review_ASCII_value_No_DPT.column_dimensions['A'].alignment = alignment
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['B'].alignment = alignment
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['C'].alignment = alignment
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['D'].alignment = alignment
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['E'].alignment = alignment
    sheet_report_review_ASCII_value_No_DPT.column_dimensions['F'].alignment = alignment
    ...
    with open(url, 'r') as f:
        ...
        ws_report_review_ASCII_value_No_DPT.append(['ID' , 'DID','RECEIVED', 'EXPECTED', 'RESULT'])
        
        for col in range(1, 6):
            cell_header = ws_report_review_ASCII_value_No_DPT.cell(1, col)
            # used hex code for red color
            cell_header.fill = PatternFill(
                start_color='000066CC', end_color='000066CC', fill_type="solid")
            cell_header.border = border
        ...
        while len(result_of_string) > 0:
            ...
            try:
                ws_report_review_ASCII_value_No_DPT.append(['ID_'+str(id) , str(DID_of_EXPECTED),str(ascii_string_of_RECEIVED), str(ascii_string_of_EXPECTED),'' , '', '','',''])
            except:
                ws_report_review_ASCII_value_No_DPT.append(['ID_'+str(id) , str(DID_of_EXPECTED),'', '' , '', '','',''])
    ...
    for row in range(2, id):
        data_validation = DataValidation(type='list', formula1 = data_validation_data)
        ws_report_review_ASCII_value_No_DPT.add_data_validation(data_validation)
        data_validation.add(ws_report_review_ASCII_value_No_DPT['E'+str(row)])
    
    wb_report_review_ASCII_value_No_DPT.save("Report_review.xlsx")
    ...
    #     wb_report_review_ASCII_value_No_DPT.save("Report_review.xlsx")
    # else:
        # wb_report_review_ASCII_value_No_DPT.save(direct_save + '/'+'Report_review.xlsx')
    
    wb_report_review_ASCII_value_No_DPT.close()


    wb_report_review_ASCII_value_No_DPT_add_result = load_workbook('Report_review.xlsx')
    ws_report_review_ASCII_value_No_DPT_add_result = wb_report_review_ASCII_value_No_DPT_add_result.active
    ws_report_review_ASCII_value_No_DPT_add_result = wb_report_review_ASCII_value_No_DPT_add_result['ASCII Value']

    sheet_report_review_add_result = wb_report_review_ASCII_value_No_DPT_add_result.worksheets[3]
    row_count_report_review_add_result = sheet_report_review_add_result.max_row
    ...
    while z < row_count_report_review_add_result + 1:
        ...
        for row in range(m, n):
            for col in range(3, 4):
                char = get_column_letter(col)
                ascii_string_of_RECEIVED_report = ws_report_review_ASCII_value_No_DPT_add_result[char + str(row)].value
                # print(ascii_string_of_RECEIVED)
        ...
        for row in range(m, n):
            for col in range(4, 5):
                char = get_column_letter(col)
                ascii_string_of_EXPECTED_report = ws_report_review_ASCII_value_No_DPT_add_result[char + str(row)].value
                # print(ascii_string_of_EXPECTED)

        if str(ascii_string_of_EXPECTED_report) == str(ascii_string_of_RECEIVED_report):
            # print('pass hex value')
            result_ascii_value_No_DPT = 'PASS'
        else:
            result_ascii_value_No_DPT = 'FAIL'


        ws_report_review_ASCII_value_No_DPT_add_result['E'+ str(z)] = str(result_ascii_value_No_DPT)

        if  str(result_ascii_value_No_DPT) == 'FAIL':
            for col in range(2, 6):
                cell_header_result_ascii_value_No_DPT = ws_report_review_ASCII_value_No_DPT_add_result.cell(v, col)
            # used hex code for red color
                cell_header_result_ascii_value_No_DPT.fill = PatternFill(
                    start_color='00FF0000', end_color='00FF0000', fill_type="solid")
                cell_header_result_ascii_value_No_DPT.border = border
                cell_header_result_ascii_value_No_DPT.font = font_text3
                cell_header_result_ascii_value_No_DPT.alignment = alignment
    ...
    wb_report_review_ASCII_value_No_DPT_add_result.save("Report_review.xlsx")

    # if direct_save == '':
    #     wb_report_review_ASCII_value_No_DPT_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_ASCII_value_No_DPT_add_result.save(direct_save + '/'+'Report_review.xlsx')

    
    wb_report_review_ASCII_value_No_DPT_add_result.close()
...
def DID_Compare(ws_report_review_DID_Compare, wb_report_review_DID_Compare,url):
    ...
    sheet_report_review_DID_Compare.column_dimensions['E'].width = 20
    ...
    for row in range(2, row_count_read_DPT):
        ...
        data_validation.add(ws_report_review_DID_Compare['E'+str(row)])
    ...
    if direct_save == '':
        ...
        wb_report_review_DID_Compare.save(direct_save + '/'+'Report_review.xlsx')
    ...
    #     wb_report_review_DID_Compare_add_dpt_value.save("Report_review.xlsx")
    # else:
    #     wb_report_review_DID_Compare_add_dpt_value.save(direct_save + '/'+'Report_review.xlsx')
    ...
    #     wb_report_review_DID_Compare_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_DID_Compare_add_result.save(direct_save + '/'+'Report_review.xlsx')
...
def Length_Byte(ws_report_review_Length_Byte, wb_report_review_Length_Byte,url):
    ...
    ws_report_review_Length_Byte = wb_report_review_Length_Byte.active
    ws_read_DPT = wb_read_DPT.active
    ws_report_review_Length_Byte_Clear = wb_report_review_Length_Byte.active
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.active
    ws_report_review_Length_Byte_add_result = wb_report_review_Length_Byte.active

    ws_report_review_Length_Byte = wb_report_review_Length_Byte['Length Byte']
    ws_report_review_Length_Byte_Clear = wb_report_review_Length_Byte['Length Byte']
    ws_read_DPT = wb_read_DPT[Sheet_DPT_Name]
    ws_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review['Length Byte']
    ws_report_review_Length_Byte_add_result = wb_report_review_Length_Byte_add_result['Length Byte']
    ...
    sheet_report_review_Length_Byte = wb_report_review_Length_Byte.worksheets[1]
    sheet_read_DPT = wb_read_DPT.worksheets[count_sheet_check]
    sheet_report_review_Length_Byte_Clear = wb_report_review_Length_Byte.worksheets[1]
    sheet_add_dpt_value_to_report_review = wb_add_dpt_value_to_report_review.worksheets[1]
    sheet_report_review_Length_Byte_add_result = wb_report_review_Length_Byte_add_result.worksheets[1]


    row_count_report_review = sheet_report_review_Length_Byte.max_row
    row_count_read_DPT = sheet_read_DPT.max_row
    row_count_report_review_Clear = sheet_report_review_Length_Byte_Clear.max_row    
    row_count_add_dpt_value_to_report_review = sheet_add_dpt_value_to_report_review.max_row
    ...
    if row_count_report_review_Clear != '':
        b = 0
        while b < row_count_report_review_Clear:
            ws_report_review_Length_Byte.delete_rows(1)
            b += 1
            print("dang xoa")
        print("done")
        b = 0
    ...
    sheet_report_review_Length_Byte.column_dimensions['F'].width = 20

    sheet_report_review_Length_Byte.column_dimensions['A'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte.column_dimensions['B'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte.column_dimensions['C'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte.column_dimensions['D'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte.column_dimensions['E'].number_format = numbers.FORMAT_TEXT
    sheet_report_review_Length_Byte.column_dimensions['F'].number_format = numbers.FORMAT_TEXT

    sheet_report_review_Length_Byte.column_dimensions['A'].alignment = alignment
    sheet_report_review_Length_Byte.column_dimensions['B'].alignment = alignment
    sheet_report_review_Length_Byte.column_dimensions['C'].alignment = alignment
    sheet_report_review_Length_Byte.column_dimensions['D'].alignment = alignment
    sheet_report_review_Length_Byte.column_dimensions['E'].alignment = alignment
    sheet_report_review_Length_Byte.column_dimensions['F'].alignment = alignment
    ...
    with open(url, 'r') as f:
        ...
        ws_report_review_Length_Byte.append(['ID' , 'DID','RECEIVED','EXPECTED','DPT','RESULT'])
        
        for col in range(1, 7):
            cell_header = ws_report_review_Length_Byte.cell(1, col)
            # used hex code for red color
            cell_header.fill = PatternFill(
                start_color='000066CC', end_color='000066CC', fill_type="solid")
            cell_header.border = border
        ...
        while len(result_of_string) > 0:
            ...
            ws_report_review_Length_Byte.append(['ID_'+str(id) , str(DID_of_EXPECTED),str(length_of_RECEIVED),str(length_of_EXPECTED),'' , '', '','',''])
    ...
    for row in range(2, row_count_read_DPT):
        data_validation = DataValidation(type='list', formula1 = data_validation_data)
        ws_report_review_Length_Byte.add_data_validation(data_validation)
        data_validation.add(ws_report_review_Length_Byte['F'+str(row)])
    ...
    #     wb_report_review_Length_Byte.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Length_Byte.save(direct_save + '/'+'Report_review.xlsx')
    ...
    ws_report_review_Length_Byte_add_dpt_value = wb_report_review_Length_Byte_add_dpt_value.active
    ws_report_review_Length_Byte_add_dpt_value = wb_report_review_Length_Byte_add_dpt_value['Length Byte']
    ...
    while l < row_count_report_review:
        ...
        ws_report_review_Length_Byte_add_dpt_value['E'+ str(l)] = str(length_byte[h])
    ...
    #     wb_report_review_Length_Byte_add_dpt_value.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Length_Byte_add_dpt_value.save(direct_save + '/'+'Report_review.xlsx')
    ...
    while z < row_count_report_review_add_result + 1:
        for row in range(m, n):
            for col in range(3, 4):
                char = get_column_letter(col)
                length_of_RECEIVED_report = ws_report_review_Length_Byte_add_result[char + str(row)].value
                # print(length_of_RECEIVED_report)
        ...
        for row in range(m, n):
            for col in range(4, 5):
                char = get_column_letter(col)
                length_of_EXPECTED_report = ws_report_review_Length_Byte_add_result[char + str(row)].value
                # print(length_of_EXPECTED)
            
        for row in range(m, n):
            for col in range(5, 6):
                char = get_column_letter(col)
                length_of_DID_DPT_report = ws_report_review_Length_Byte_add_result[char + str(row)].value
        ...
        ws_report_review_Length_Byte_add_result['F'+ str(z)] = str(result_length_value)

        if str(result_length_value) == 'FAIL':
            for col in range(2, 7):
                cell_header_result_length_value = ws_report_review_Length_Byte_add_result.cell(v, col)
            # used hex code for red color
                cell_header_result_length_value.fill = PatternFill(
                    start_color='00FF0000', end_color='00FF0000', fill_type="solid")
                cell_header_result_length_value.border = border
    ...
    #     wb_report_review_Length_Byte_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Length_Byte_add_result.save(direct_save + '/'+'Report_review.xlsx')
...
def Hex_value(ws_report_review_Hex_value, wb_report_review_Hex_value,url):
    ...
    for row in range(2, row_count_read_DPT):
        ...
        data_validation.add(ws_report_review_Hex_value['F'+str(row)])
    ...
    #     wb_report_review_Hex_value.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Hex_value.save(direct_save + '/'+'Report_review.xlsx')
    ...
    #     wb_report_review_Hex_value_add_dpt_value.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Hex_value_add_dpt_value.save(direct_save + '/'+'Report_review.xlsx')
    ...
    #     wb_report_review_Hex_value_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_Hex_value_add_result.save(direct_save + '/'+'Report_review.xlsx')
...
def ASCII_Value(ws_report_review_ASCII_value, wb_report_review_ASCII_value,url):
    ...
    for row in range(2, row_count_read_DPT):
        ...
        data_validation.add(ws_report_review_ASCII_value['F'+str(row)])
    ...
    #     wb_report_review_ASCII_value.save("Report_review.xlsx")
    # else:
    #     wb_report_review_ASCII_value.save(direct_save + '/'+'Report_review.xlsx')
    ...
    #     wb_report_review_ASCII_value_add_dpt_value.save("Report_review.xlsx")
    # else:
    #     wb_report_review_ASCII_value_add_dpt_value.save(direct_save + '/'+'Report_review.xlsx')
    ...
    #     wb_report_review_ASCII_value_add_result.save("Report_review.xlsx")
    # else:
    #     wb_report_review_ASCII_value_add_result.save(direct_save + '/'+'Report_review.xlsx')
...
def start_program():
    ...
    if direct_DPT != '':
        ...
        create_DPT_can_load_file(direct_DPT,url)
        ...
        if direct_save != '':
            wb_convert_save_file = load_workbook('Report_review.xlsx')

            direct_report = Input_report_path_text.get()

            ws_convert_save_file = wb_convert_save_file.active

            sheet_convert_save_file = wb_convert_save_file.worksheets[0]

            wb_convert_save_file.save(direct_save + '/'+'Report_review.xlsx')
            wb_convert_save_file.close()
            os.remove("Report_review.xlsx")
    else:
        DID_Compare_No_DPT(ws_report_review, wb_report_review,url)
        Length_Byte_No_DPT(ws_report_review, wb_report_review,url)
        Hex_value_No_DPT(ws_report_review, wb_report_review,url)
        ASCII_Value_No_DPT(ws_report_review, wb_report_review,url)
